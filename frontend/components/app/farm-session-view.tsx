...
export function FarmSessionView({ onEnd }: FarmSessionViewProps) {
  ...
  return (
    <section className="farm-shell flex min-h-svh items-center justify-center px-4 py-8 text-center">
      <div className="farm-card w-full max-w-2xl px-5 py-9 sm:px-10">
        ...
        <Button
          ...
          size="lg"
          onClick={leave}
          className="mt-8 min-h-12 rounded-xl border-red-200 px-6 font-bold text-red-700 hover:bg-red-50 hover:text-red-800"
        >
